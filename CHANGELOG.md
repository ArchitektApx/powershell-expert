...
### Added
- Claude Code plugin marketplace support: Install via `/plugin marketplace add ArchitektApx/powershell-expert` then `/plugin install powershell-expert@powershell-expert`
